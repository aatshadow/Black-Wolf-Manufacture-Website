...
const steps = [
  { week: "WEEK 1", number: "1", label: "Discovery", desc: "Audit your current operations and identify key bottlenecks" },
  { week: "WEEK 2", number: "2", label: "Architecture", desc: "Custom system design tailored to your workflows" },
  { week: "WEEK 3", number: "3", label: "Build", desc: "Development and configuration of your infrastructure" },
  { week: "WEEK 4", number: "4", label: "Deploy", desc: "Implementation, data migration, and team onboarding" },
  { week: "WEEK 5", number: "5", label: "Optimize", desc: "Monitoring, AI tuning, and performance optimization" },
];
    ...
    <section className="relative bg-transparent py-16 md:py-32" ref={ref}>
      <div className="mx-auto max-w-[1200px] px-4 md:px-6">
        ...
        >
          ...
          <p className="text-sm text-white/40 md:text-base">From chaos to control in 5 weeks</p>
        </motion.div>
